<template>
    <div class="goods" v-if="shopInfo">
              ...
              >
                ...
                >
                  ...
                  <section class="fooddetails-info">
                    <h4>{{food.name}}</h4>
                    <p class="fooddetails-des"></p>
                    <p class="fooddetails-sales">月售{{food.month_sales}}份 好评率{{food.satisfy_count}}</p>
        ...
        <Food :food="selectFood" :showFood="showFood" @close="close"/>
    </div>
</template>
