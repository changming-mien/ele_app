  ...
  <div class="myAddress">
    ...
    <div class="address-view">
      <div class="address-card" v-for="(address,index) in allAddress" :key="index">
        ...
        <div class="address-card-body" @click="selectAddress(address,index)">
...
export default {
    ...
    methods:{
        ...
        getData(){
          ...
          .then(res=>{this.allAddress=res.data.myAddress})
        ...
        handleDelete(address){
          this.$axios.delete(`/api/user/address/${localStorage.ele_login}/${address._id}`)
