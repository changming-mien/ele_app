<template>
  <div :class="{'open':isShow||isScreen}" @click.self="hideShow">
      <!-- 导航 -->
...
export default {
    ...
    methods:{
        filterSort(index){
            ...
            switch(index){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this.$emit("updata",{condation:this.filterData.navTab[2].condition})
                    break;
                case 3:
                    this.isShow=false;
                    this.isScreen=true;
        ...
        selectSort(item,index){
            ...
            this.filterData.navTab[0]=item;
            this.hideShow();
            // 更新数据
            this.$emit("updata",{condition:item.code})
        },
        selectScreen(item,screen){
            if(screen.id=="offer"||screen.id=="per"){
